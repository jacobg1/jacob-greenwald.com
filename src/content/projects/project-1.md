...
The front end is built in [React](https://reactjs.org/) with HTML, CSS and TypeScript. The back end is built in [NestJS](https://nestjs.com/), a Node based JavaScript framework.
